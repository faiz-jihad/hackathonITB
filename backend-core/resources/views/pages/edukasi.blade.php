    ...
    <div class="max-w-6xl mx-auto px-4 py-4 md:py-8" x-data="{ 
        ...
        <div class="relative rounded-[2rem] md:rounded-[3rem] overflow-hidden mb-10 md:mb-16 shadow-2xl min-h-[300px] md:min-h-[400px] flex items-center justify-center">
            ...
            <div class="relative z-10 px-6 py-12 md:py-32 text-center text-white">
                <div class="inline-flex items-center gap-2 bg-emerald-500/20 backdrop-blur-md border border-white/20 text-emerald-300 px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-in">
                    <i class="bi bi-mortarboard"></i>
                    <span>Pusat Edukasi Lengkap</span>
                </div>
                <h2 class="text-3xl md:text-7xl font-heading font-bold mb-4 md:mb-6 tracking-tight animate-fade-in-up">
                    Pusat Edukasi <span class="text-emerald-400 italic">S.E.E.D</span>
                </h2>
                <p class="text-lg md:text-2xl text-emerald-50/90 max-w-3xl mx-auto font-light leading-relaxed mb-8 md:mb-10 animate-fade-in-up animation-delay-200">
        ...
        <div class="mb-16 md:mb-24 bg-white/50 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 border border-white/50 shadow-xl overflow-hidden relative">
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="relative text-center group">
                        ...
                        <div class="hidden md:block absolute top-10 -right-4 text-emerald-500/20 text-3xl">→</div>
                    </div>
                    ...
                    <div class="relative text-center group">
                        ...
                        <div class="hidden md:block absolute top-10 -right-4 text-blue-500/20 text-3xl">→</div>
                    </div>
                    ...
                    <div class="relative text-center group">
                        ...
                        <div class="hidden md:block absolute top-10 -right-4 text-purple-500/20 text-3xl">→</div>
                    </div>
        ...
        <!-- Quick Stats Banner -->
        <div class="bg-gradient-to-r from-emerald-600 to-emerald-800 rounded-3xl p-8 mb-16 text-white">
            ...
            <div class="mb-16">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div class="text-center md:text-left">
                        ...
                        <p class="text-gray-600 mt-1">Dilengkapi dengan istilah lokal bahasa Jawa untuk memudahkan petani
                        </p>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <template x-if="activeTab === 'semua' || activeTab === 'jamur'">
                        <div class="grid grid-cols-1 gap-6">
                            <!-- Blast -->
                            <div class="bg-white/60 backdrop-blur-md rounded-[1.5rem] md:rounded-[2rem] border border-white/50 shadow-xl shadow-amber-500/5 overflow-hidden group/card hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-500"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-amber-50/80 backdrop-blur-sm rounded-2xl p-4 border border-amber-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Bercak belah ketupat, pusat abu-abu, tepi coklat kemerahan. Leher malai busuk (gulu padi patah)</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Fungisida sistemik, tanam varietas tahan, hindari pemupukan N berlebihan</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-amber-50/80 backdrop-blur-sm rounded-2xl p-4 border border-amber-100/50">
                                                    <span class="text-amber-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Bintik coklat bundar kecil pada daun, berkembang menjadi bercak oval dengan halo kuning</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Pemupukan berimbang (terutama Si & K), fungisida mancozeb, pengelolaan air baik</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-amber-50/80 backdrop-blur-sm rounded-2xl p-4 border border-amber-100/50">
                                                    <span class="text-amber-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Lapisan putih seperti tepung/bulu halus pada permukaan atas dan bawah daun</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Fungisida kontak (mancozeb), perbaiki drainase, jarak tanam tidak terlalu rapat</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-amber-50/80 backdrop-blur-sm rounded-2xl p-4 border border-amber-100/50">
                                                    <span class="text-amber-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Bercak oval pada pelepah dekat air, berwarna abu-abu kehijauan dengan tepi coklat</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Fungisida validamycin, kurangi pupuk N, tanam varietas tahan, drainase baik</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-green-50/80 backdrop-blur-sm rounded-2xl p-4 border border-green-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Menguning dari tepi daun, lesi bergelombang putih kekuningan, daun seperti terbakar</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Bakterisida tembaga, varietas tahan, drainase baik, hindari genangan</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-green-50/80 backdrop-blur-sm rounded-2xl p-4 border border-green-100/50">
                                                    <span class="text-green-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Garis-garis transparan memanjang antar tulang daun, berubah coklat kekuningan</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Benih sehat bersertifikat, bakterisida tembaga, sanitasi lahan</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-green-50/80 backdrop-blur-sm rounded-2xl p-4 border border-green-100/50">
                                                    <span class="text-green-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Malai busuk berwarna coklat kehitaman, banyak gabah hampa</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Waktu tanam tepat, bakterisida, gunakan benih sehat</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-red-50/80 backdrop-blur-sm rounded-2xl p-4 border border-red-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Tanaman kerdil, daun kuning-oranye, jumlah anakan berkurang drastis</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Insektisida untuk wereng, tanam serempak, varietas tahan wereng</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-red-50/80 backdrop-blur-sm rounded-2xl p-4 border border-red-100/50">
                                                    <span class="text-red-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Tanaman kerdil parah, daun pendek sempit, anakan berlebihan</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Kendalikan wereng coklat, tanam varietas tahan, eradikasi tanaman sakit</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <template x-if="activeTab === 'semua' || activeTab === 'hama'">
                        <div class="grid grid-cols-1 gap-6">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-purple-50/80 backdrop-blur-sm rounded-2xl p-4 border border-purple-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Sundep: pucuk mati mudah dicabut. Beluk: malai putih hampa.</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Insektisida sistemik, musuh alami (Trichogramma), tanam serempak</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-purple-50/80 backdrop-blur-sm rounded-2xl p-4 border border-purple-100/50">
                                                    <span class="text-purple-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Garis putih memanjang di daun, bercak putih akibat gigitan dewasa</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Insektisida kontak (sipermetrin), genangi sawah, musuh alami</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Wereng Coklat -->
                            <div class="bg-white/60 backdrop-blur-md rounded-[2rem] border border-white/50 shadow-xl shadow-purple-500/5 overflow-hidden group/card hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-500"
                                x-show="!searchQuery || 'wereng coklat wereng coklat nilaparvata'.includes(searchQuery.toLowerCase())">
                                <div class="p-6">
                                    <div class="flex items-start gap-4">
                                        <div class="w-12 h-12 rounded-xl bg-purple-100/80 backdrop-blur-sm text-purple-600 flex items-center justify-center flex-shrink-0 group-hover/card:scale-110 transition-transform">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-purple-50/80 backdrop-blur-sm rounded-2xl p-4 border border-purple-100/50">
                                                    <span class="text-purple-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Tanaman mengering melingkar (hopperburn), serangga di pangkal batang</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Insektisida (BPMC, fipronil), tanam varietas tahan, hindari insektisida spektrum luas</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-purple-50/80 backdrop-blur-sm rounded-2xl p-4 border border-purple-100/50">
                                                    <span class="text-purple-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-search"></i> Gejala Khas</span>
                                                    <span class="text-gray-700 leading-relaxed">Bercak putih kecil pada daun, tanaman kerdil, vektor virus Tungro</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Insektisida saat populasi tinggi, tanam serempak, varietas tahan wereng</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                <div class="bg-pink-50/80 backdrop-blur-sm rounded-2xl p-4 border border-pink-100/50">
                                                    ...
                                                    <span class="text-gray-700 leading-relaxed">Pembengkakan pada akar (puru), tanaman kerdil, daun menguning</span>
                                                </div>
                                                <div class="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100/50">
                                                    <span class="text-emerald-700 font-bold flex items-center gap-2 mb-2"><i class="bi bi-capsule"></i> Solusi</span>
                                                    <span class="text-gray-700 leading-relaxed">Nematisida, rotasi tanaman, penggenangan lahan, bahan organik</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- No Result Message -->
                    <div x-show="searchQuery && !document.querySelectorAll('[x-show*=\" searchQuery\"]').length"
                        class="text-center py-12 bg-white rounded-2xl border border-gray-200">
                        <div class="text-4xl mb-4"><i class="bi bi-search text-gray-300"></i></div>
            ...
            <div class="bg-white/40 backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 mb-16 border border-white/50 shadow-xl">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/50 shadow-sm hover:shadow-md transition-all">
                        ...
                        <h4 class="font-semibold text-gray-900 mb-2">Kultur Teknis</h4>
                        <ul class="text-xs text-gray-600 text-left space-y-1.5 opacity-80">
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/50 shadow-sm hover:shadow-md transition-all">
                        ...
                        <h4 class="font-semibold text-gray-900 mb-2">Varietas Tahan</h4>
                        <ul class="text-xs text-gray-600 text-left space-y-1.5 opacity-80">
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/50 shadow-sm hover:shadow-md transition-all">
                        ...
                        <h4 class="font-semibold text-gray-900 mb-2">Hayati</h4>
                        <ul class="text-xs text-gray-600 text-left space-y-1.5 opacity-80">
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/50 shadow-sm hover:shadow-md transition-all">
                        ...
                        <h4 class="font-semibold text-gray-900 mb-2">Kimiawi</h4>
                        <ul class="text-xs text-gray-600 text-left space-y-1.5 opacity-80">
            ...
            <!-- Lifecycle Section -->
            <div class="mb-16">
                <h3 class="text-2xl font-heading font-bold text-gray-900 mb-8 text-center"><i class="bi bi-calendar-event text-emerald-600"></i> Fase Rentan Tanaman Padi</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead class="bg-emerald-50/50">
                                <tr>
                                    <th class="px-6 py-4 text-left font-bold text-emerald-900 uppercase tracking-wider">Fase Pertumbuhan</th>
                                    <th class="px-6 py-4 text-left font-bold text-emerald-900 uppercase tracking-wider">Penyakit/Hama Rentan</th>
                                    <th class="px-6 py-4 text-left font-bold text-emerald-900 uppercase tracking-wider">Tindakan Pencegahan</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-emerald-100/30">
                                <tr class="hover:bg-emerald-50/30 transition-colors">
                                    <td class="px-6 py-4 font-semibold text-gray-800">Persemaian (0-21 HSS)</td>
                                ...
                                <tr class="hover:bg-emerald-50/30 transition-colors">
                                    <td class="px-6 py-4 font-semibold text-gray-800">Vegetatif Awal (21-35 HST)</td>
                                ...
                                <tr class="hover:bg-emerald-50/30 transition-colors">
                                    <td class="px-6 py-4 font-semibold text-gray-800">Vegetatif Akhir (35-55 HST)</td>
                                ...
                                <tr class="hover:bg-emerald-50/30 transition-colors">
                                    <td class="px-6 py-4 font-semibold text-gray-800">Generatif (55-85 HST)</td>
                                ...
                                <tr class="hover:bg-emerald-50/30 transition-colors">
                                    <td class="px-6 py-4 font-semibold text-gray-800">Pemasakan (85 HST - Panen)</td>
                ...
                <div class="space-y-4">
                    <div class="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 overflow-hidden shadow-sm hover:shadow-md transition-all" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="w-full px-6 py-5 text-left flex items-center justify-between hover:bg-white/40 transition-colors">
                            <span class="font-bold text-gray-900">Apa perbedaan Kresek dan Blas?</span>
                            <i :class="open ? 'bi bi-chevron-up text-emerald-600' : 'bi bi-chevron-down text-gray-400'" class="transition-transform duration-300"></i>
                        </button>
            ...
            <div class="bg-white/40 backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 border border-red-100 shadow-xl mb-16 relative overflow-hidden">
            ...
            <div class="text-center bg-white/70 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 border border-white shadow-2xl relative overflow-hidden group">
                ...
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-emerald-500/5 to-teal-500/5 -z-10"></div>
                ...
                <div class="flex flex-col items-center gap-6">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 text-sm font-medium text-emerald-700">
                        <span class="flex items-center gap-1.5 bg-emerald-50 px-3 py-1 rounded-full"><i class="bi bi-lightning-fill"></i> Cepat</span>
                        <span class="flex items-center gap-1.5 bg-emerald-50 px-3 py-1 rounded-full"><i class="bi bi-bullseye"></i> Akurat</span>
                        <span class="flex items-center gap-1.5 bg-emerald-50 px-3 py-1 rounded-full"><i class="bi bi-translate"></i> Istilah Lokal</span>
                        <span class="flex items-center gap-1.5 bg-emerald-50 px-3 py-1 rounded-full"><i class="bi bi-gift-fill"></i> Gratis</span>
                    </div>
                </div>
            </div>
        </div>
